...
const ImgInput = (props) => {
  ...
  const handleClick = async() => {
    try{
      ...
      data.append("upload_preset", "snwmywjm")
      data.append("cloud_name", "dxvvkb69a")
      const response = await fetch("https://api.cloudinary.com/v1_1/dxvvkb69a/image/upload", {method: "POST", body: data})
